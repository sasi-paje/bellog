        ...
        <div className="bg-white rounded-[8px] w-full min-w-[50vw] flex flex-col overflow-hidden shadow-xl">
          ...
          <div className="flex flex-col gap-4 p-8">
            <p className="font-medium text-[14px] text-[#2a2a2a] leading-relaxed">
              Tem certeza que deseja remover a nota <span className="font-bold">NF {invoiceNumber}</span> desta rota?
            </p>
            <div className="p-4 bg-[#fff8e6] rounded-[8px] border border-[#e67c26]/20">
              <div className="flex items-start gap-3">
                <div className="w-[20px] h-[20px] shrink-0 mt-0.5">
                  <AppIcon name="info" size={20} color="#e67c26" />
                </div>
                <p className="font-medium text-[14px] text-[#2a2a2a] leading-relaxed">
                  Após remoção, a nota voltará à lista de notas disponíveis.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end gap-4 h-[45px] px-8 shrink-0 border-t border-[#e0e0e0]">
            ...
            <button
              ...
              onClick={onConfirm}
              disabled={loading}
              className="flex items-center justify-center h-[40px] px-[16px] py-[2px] rounded-[4px] bg-[#dc2626] text-white font-bold text-[14px] disabled:opacity-50 hover:bg-[#b91c1c] transition-colors"
            >
              {loading ? 'Removendo...' : 'Remover Nota'}
            </button>
          </div>
        </div>
      </div>
