...
import { recusasData } from '../data/recusas.mock'

interface RecusasPageProps {
  data?: typeof recusasData
  userName?: string
  userRole?: string
  onBack?: () => void
        ...
        <div className="flex items-center">
          ...
          <div className="bg-[#f9f9f9] border border-[#bdbdbd] flex items-center h-10 rounded-[5px] w-[526px]">
            <div className="flex flex-1 items-center h-full px-[8px]">
              <span className="font-normal text-[14px] text-[#bdbdbd]">Busque por motivos de Recusas...</span>
            </div>
