...
--
-- Execute no Supabase Dashboard > SQL Editor do projeto bkaqywslrgyqsvaumwnv.
-- O mobile usa SASI e chega sem sessao Supabase Auth, por isso o upload direto
-- para Storage roda como role anon.
