...
export interface FornecedoresFilterData {
  groupId: string
  cnpj: string
  zipCode: string
  street: string
...
export const EMPTY_FORNECEDORES_FILTERS: FornecedoresFilterData = {
  groupId: '',
  cnpj: '',
  zipCode: '',
  street: '',
...
interface FornecedoresToolbarProps {
  onSearch?: (term: string) => void
  onAddNew?: () => void
  onBack?: () => void
  onFilter?: (filters: FornecedoresFilterData) => void
...
export const FornecedoresToolbar = ({
  onSearch,
  onAddNew,
  onBack,
  onFilter,
  initialSearch = '',
  groups,
}: FornecedoresToolbarProps) => {
  const [searchValue, setSearchValue] = useState(initialSearch)
  const [showFilters, setShowFilters] = useState(false)
  const [filters, setFilters] = useState<FornecedoresFilterData>(EMPTY_FORNECEDORES_FILTERS)
  ...
  const set = (field: keyof FornecedoresFilterData) => (value: string) =>
    setFilters(prev => ({ ...prev, [field]: value }))

  const handleClearFilters = () => {
    setFilters(EMPTY_FORNECEDORES_FILTERS)
    onFilter?.(EMPTY_FORNECEDORES_FILTERS)
  }
